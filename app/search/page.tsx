...
const resultCards = [
  ...
  },
  {
    ...
    label: "ARCHIVE_02",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuCBfvMtHtH-mb_b0pWofx_sAsQ-NgwBF86Hb0M4M7m64D641EDBHxJ4YQeYsqvcxVRi9dFpEfcriBkggbHESApz9WH8-ddbLGY5BPS5XMtYnxY0GzZHnBMLah5tJqPui2_EcBSNd3SR_4-x0KUpyjN4GVa10Pql-ELj0Jg4Pzyr9kuaSh1ZTp62HSm1bJ7KZXh2B2oUAAiXFeVMjTGt_u-WBlIXxp_3Ius0odl0syR8lYfJsttFf6kWk0DPuxgHGm9FaDfyxT3UVLc",
  },
  {
      ...
      <div className="shell">
        <div className="search-panel">
          ...
          <div className="search-input-wrap">
            <input className="search-input" type="text" placeholder="EXECUTE_QUERY_" defaultValue="" />
            <span className="search-input__cursor" aria-hidden="true" />
          </div>
          ...
          <div className="search-panel__bottom">
            <div className="search-tag-row">
              ...
              <span className="search-pill">UI_Systems</span>
              <span className="search-pill">Architecture</span>
            </div>
